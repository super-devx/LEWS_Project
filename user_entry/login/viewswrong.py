  ...
  if chart_type == 'bar': 
    ...
    for row in range(0,len(sensor_id)):
      ...
      if not(flag):      
        ...
        ax1.legend(bbox_to_anchor=(.85,1.25), loc='upper center', prop=font)
      ...
      if len(set_ty)>=2 and flag and ab:
        ...
        ax2.legend(bbox_to_anchor=(0.2,1.25), loc='upper center', prop=font,ncol=1)
        #ax2.xaxis.set_major_locator(locator)
        ab=False
        sx=[]
        sy=[]
      ...
      if len(set_ty)>=2 and flag and  flag1:
        ...
        ax3.legend(bbox_to_anchor=(.845,1.185), loc='upper center', prop=font)   
